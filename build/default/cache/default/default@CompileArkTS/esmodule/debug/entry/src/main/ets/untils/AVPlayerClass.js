...
// 5.当前播放模式
AVPlayerClass.playMode = 'random';
// 6.当前的播放列表
AVPlayerClass.playList = [];
// 7.当前的播放序号
AVPlayerClass.playIndex = -1;
//# sourceMappingURL=AVPlayerClass.js.map