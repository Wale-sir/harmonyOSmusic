...
export const tabsData = [
    {
        title: '推荐',
        name: 'recommend',
        icon: { "id": 16777254, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }
    }, {
        title: '发现',
        name: 'find',
        icon: { "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }
    }, {
        title: 'music',
        name: 'home',
        icon: { "id": 16777270, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }
    }, {
        title: '动态',
        name: 'moment',
        icon: { "id": 16777247, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }
    }, {
        title: '我的',
        name: 'mine',
        icon: { "id": 16777246, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }
    }
];
// 轮播图数据
...
export const dailyRecommend = [
    {
        img: 'http://p1.music.126.net/psth_fcCEKjDVXRtijL_DQ==/1383185632930533.jpg?param=140y140',
    ...
    {
        img: 'http://p1.music.126.net/dMlINUxUskjYg30JTRYexw==/19221662277102979.jpg?param=140y140',
...
export const favoriteList = {
    name: "我喜欢的音乐",
    nickName: "Wale",
    avatar: { "id": 16777270, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" },
    songs: songs
};
// 动态列表
...
//# sourceMappingURL=musicsj.js.map